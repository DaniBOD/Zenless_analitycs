...
| 2 | `inventory_weapons` | **43** | Censo en vivo 2026-09-08/10/11 (mig `_26` + `WeaponSyncer`): sólo equipadas, `origen_evidencia='s30_badge'`; las libres se cuentan pero no se escriben (v1). Las 50 de antes eran la transcripción de abril, vaciada en el rebuild del 2026-08-17 |
