...
| 3 Thresholds | `agent_thresholds` | **111** | 47/51 PJs con ≥1 stat · Velina, Pyrois, Remielle Dan y **Aria** PENDIENTE (objetivos Prydwen, RNF-02) |
| 3 | `agent_score_thresholds` | **51** | Defaults equip 0.75 / stock 0.50, overridable (todos los 51 PJs) |
...
| 8 | `pj_weapon_synergy` | **294** | 49 PJs × 6 categorías (+ Pyrois matriz Ataque, + Remielle Dan y **Aria** matriz Anomalía) · Billy Estelar PENDIENTE (rol Disruptivos/Rupture sin matriz confirmada — RNF-02) |
