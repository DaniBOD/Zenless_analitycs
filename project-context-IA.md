...
| 2 | `inventory_weapons` | **55** | Censo en vivo 2026-09-08/10/11 (mig `_26` + `WeaponSyncer`): 44 equipadas (`origen_evidencia='s30_badge'`) + **11 libres** (`'s30_libre'`, sin dueño, desde el 2026-09-11; clave = arma + nivel + P + número de copia de la grilla). Las 50 de antes eran la transcripción de abril, vaciada en el rebuild del 2026-08-17 |
